 ...
 */
function thunderbear_edd_fes_author_url( $author = null ) {
 ...
 */
function thunderbear_comment_author_image_size( $size ) {
	return 75;
}
add_filter( 'fes_get_avatar_size_comment_author_image', 'thunderbear_comment_author_image_size' );


/**
 * check for FES shortcodes and add post classes
 */
function thunderbear_fes_shortcodes_classes( $classes ) {
	global $post;
...
add_filter( 'post_class', 'thunderbear_fes_shortcodes_classes' );