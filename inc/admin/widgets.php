...
/**
 * Thunderbear Download Author Information Widget
 *
 * This widget is designed to replace the default author info widget that
 * displays in the Thunderbear download sidebar by default. This purely exists
 ...
 * @package Thunderbear
 */
class thunderbear_Author_Details extends WP_Widget {
...
/**
 * Thunderbear Download Details Information Widget
 *
 ...
 * @package Thunderbear
 */
class thunderbear_Download_Details extends WP_Widget {
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( thunderbear_SL_is_activated() ) {
 ...
 * @package Thunderbear
 */
function thunderbear_register_widgets() {
	register_widget( 'thunderbear_Author_Details' );
	register_widget( 'thunderbear_Download_Details' );
}
add_action( 'widgets_init', 'thunderbear_register_widgets' );