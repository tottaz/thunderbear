...
class Thunderbear_Updater_Admin {
	...
	function admin_styles() {
		wp_enqueue_style( 'thunderbear-admin-style', get_template_directory_uri() . '/inc/admin/admin.css' );
	}
	...
	function updater() {
		...
		if ( ! class_exists( 'thunderbear_Updater' ) ) {
			// Load our custom theme updater
			include( dirname( __FILE__ ) . '/theme-updater-class.php' );
		}

		new thunderbear_Updater(
			array(
	...
	function license_page() {
		...
		<div class="wrap license-wrap">
			<h2 class="headline"><?php echo sprintf( __( '%s License Key & Child Theme Management', 'thunderbear' ), THUNDERBEAR_NAME ); ?></h2>
			<div class="thunderbear-license-management-wrap">
				<h2 class="thunderbear-license-management-headline"><?php echo sprintf( __( 'Activate Your %s License Key', 'thor-thunderbear' ), THUNDERBEAR_NAME ); ?></h2>
				<p>
					<?php echo sprintf( __( 'Your license key grants you access to theme updates and support. If your license key is deactivated or expired, your theme will work properly but you will not receive automatic updates.', 'thor-thunderbear' ) );
					?>
				</p>
				<h3><strong><?php _e( 'License activation instructions', 'thor-thunderbear' ); ?></strong></h3>
				<ol class="thunderbear-license-instructions">
		...
		<div class="wrap child-theme-wrap">
			<?php
			/*
			 * only show child theme instructions if Thunderbear is the active theme
			 */
...
Author:
Author URI:
Description: Child theme for Thunderbear
Template: thor-thunderbear
*/
...
/* ----- Theme customization starts here ----- */
					...
					<li><?php printf( __( 'You may edit all of what you pasted EXCEPT for the <code>Template: thunderbear</code> line. Leave that line alone or the child theme will not attach itself to %s.', 'thor-thunderbear' ), THUNDERBEAR_NAME ); ?></li>
...
function thunderbear_child_enqueue_styles() {
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css' );
}
add_action( 'wp_enqueue_scripts', 'thunderbear_child_enqueue_styles' );
</pre>
					</li>
					<li><?php _e( 'With your new child theme folder in place, the above CSS pasted inside of your <code>style.css</code> file, and the above PHP pasted inside of your <code>functions.php</code> file, go back to your WordPress dashboard and navigate to "Appearance -> Themes" and locate your new theme (you\'ll see the name you chose). Activate your theme.', 'thor-thunderbear' ); ?></li>
					<li><?php _e( 'With your child theme activated, you can edit its stylesheet all you like. You may also add custom functions to your new functions file.', 'thor-thunderbear' ); ?></li>
					<li><?php _e( 'Enjoy!', 'thor-thunderbear' ); ?></li>
				</ol>
				<?php
			} else {
				echo sprintf( '<h3>' . __( 'You are currently using a child theme for %s.', 'thor-thunderbear' ) . '</h3>', thunderbear_NAME );
			}
			?>
		</div>
		<?php
